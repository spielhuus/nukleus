...
draw.add(Element("U1", "Amplifier_Operational:TL072", unit=2, on_schema=False).at((30, 50)))
draw.add(Element("U1", "Amplifier_Operational:TL072", unit=3, on_schema=False).at((50, 50)))
draw.add(Element("+15V", "power:+15V", on_schema=False).at(draw.U1[3].getPins()['8']))
draw.add(Element("-15V", "power:-15V", on_schema=False).at(draw.U1[3].getPins()['4']).rotate(180))
